        ...
        <G label="Search">
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-2.5 py-1.5 min-w-[190px] text-sm rounded-xl border bg-slate-800/80 border-white/[0.08] text-white placeholder:text-white/30 outline-none transition-all duration-150 focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20"
            />
          </div>
        </G>
      </div>
...
function DateIn({ value, onChange }) {
  return (
    <input
      ...
      className="px-2.5 py-1.5 text-sm rounded-xl border bg-slate-800/80 border-white/[0.08] text-white outline-none transition-all duration-150 focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20 [color-scheme:dark] hover:border-white/20"
    />
  )
}
