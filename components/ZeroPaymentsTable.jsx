...
import { CellSelect, CellInput, matchTone, statusTone, locationTone, RowMenu } from './cells'
...
// ─────────────────────────────────────────────────────────────────────────────
const COLS = [
  { key: 'eobDate',       label: 'EOB Date',  width: 140 },
                      ...
                      {confirmId === e.id ? (
                        ...
                        {onOpenAttachments && (
                          <button
                            ...
                            title={attachmentCounts[e.id] ? `${attachmentCounts[e.id]} EOB file${attachmentCounts[e.id] !== 1 ? 's' : ''}` : 'Attach EOB'}
                            className="relative p-1.5 rounded-lg text-slate-400 hover:text-violet-600 hover:bg-violet-100 transition-colors"
                          >
                        ...
                        {/* Same hierarchy as the ACH table: the frequent action stays
                            an icon, the rest live behind the menu. */}
                        <RowMenu
                          items={[
                            onOpenActivity && {
                              label: 'View activity',
